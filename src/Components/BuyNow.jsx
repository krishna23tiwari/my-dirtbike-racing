...
const BuyNow = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-400 flex flex-col justify-center items-center p-6 sm:p-10 mt-16">
      {/* Product Details Section */}
      <div className="bg-gray-300 p-6 sm:p-10 shadow-lg rounded-lg w-full max-w-4xl flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-black mt-3">{product.productdesc || product.description}</p>
      ...
      {/* Payment Section */}
      <div className="bg-gray-300 p-6 sm:p-10 shadow-lg rounded-lg w-full max-w-5xl flex flex-col md:flex-row gap-8 mt-10">
        <div className="w-full md:w-1/2 border-b md:border-r md:border-b-0 pb-6 md:pb-0 md:pr-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-6 text-center">
            Choose Payment Method
          </h1>
